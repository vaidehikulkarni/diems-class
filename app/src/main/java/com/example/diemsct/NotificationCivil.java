...
public class NotificationCivil extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_notification_civil, container, false);
        ...
        for (int i = 0; i < NotificationActivity.jsonArray.length(); i++) {
            try {
                ...
                if (js.getString("branch").toLowerCase().equals("civil")) {
